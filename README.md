...
#### `POST /api/frontend/oauth/get-authorization-uri/`
##### Returns
- HTTP Response 200 if successful:
```
{
    authorizationUri: "URI HERE"
}
```
- HTTP Response 400 if unsuccessful
##### Headers
...
#### `GET/POST /api/frontend/finalize-connection/jira/get-jira-sites`
REFACTOR THIS INTO A GET REQUEST PROBABLY?
Takes in connection_code as a param
It is read only, and always is same given same code, so yes
